    ...
    return(
        <header className='w-full border-b border-slate-300'>
            <div className='w-full flex justify-center items-center py-1.5 bg-slate-900 text-amber-50'>
                <p className='font-bold italic text-center text-xs select-none'>Compre sem burocracia aqui no Guitar Shop! <span className='font-normal'>Promoções</span> todos os dias </p>
            </div>
